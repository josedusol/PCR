...
EXTENDS PCRMergeSort2RTypes, PCRBase1R, TLC
...
R_call(I) == 
  \E i \in iterator(I) :
    ...
    /\ ~ \E j \in iterator(I) : /\ j # i 
                                /\ merge!wellDef(I \o <<j>>)    \* merge!wellDef(I \o <<j>>) 
                                /\ pending(I, j)                \*  ~ merge!finished(I \o <<j>>)         
    /\ cm'  = [cm  EXCEPT 
         ![I].v_c[i].r = @ + 1] 
    /\ cm2' = [cm2 EXCEPT 
...
\* Last modified Thu Dec 10 16:20:06 UYT 2020 by josedu
