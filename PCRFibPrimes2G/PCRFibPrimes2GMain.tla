------------------------- MODULE PCRFibPrimes2GMain ------------------------

(*
   Main module for PCR FibPrimes2.
*)

EXTENDS PCRFibPrimes2GTypes, FiniteSets
...
PCR1 == INSTANCE PCRFibPrimes2G WITH 
  InType    <- InType1,
...
PCR2 == INSTANCE PCRIsPrimeG WITH
  InType    <- InType2,  
...
PCRFibPrimes1 == INSTANCE PCRFibPrimes1GMain 
  WITH cm1 <- subst,
       im1 <- im1

=============================================================================
\* Modification History
\* Last modified Sat Nov 07 01:31:56 UYT 2020 by josedu
