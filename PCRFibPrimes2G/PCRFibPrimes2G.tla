...
EXTENDS PCRFibPrimes2GTypes, PCRBaseG, TLC
...
PCRisPrime == INSTANCE PCRIsPrimeG WITH
  InType    <- InType2,
...
INSTANCE PCRIterationSpaceG WITH
  lowerBnd  <- lowerBnd,
  upperBnd  <- upperBnd,  
  step      <- step
...
\* Last modified Sat Nov 07 19:42:15 UYT 2020 by josedu
