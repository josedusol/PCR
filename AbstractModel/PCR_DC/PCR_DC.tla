...
RInv2 == 
  \A I \in WDIndex :
    r[I] = M!BigOpP(1, uBnd(X[I]),
                    LAMBDA i : red(I,i), 
                    LAMBDA i : fr(X[I],c[I],i))                                 
...
\* Last modified Wed Sep 08 19:31:41 UYT 2021 by josedu
\* Last modified Wed Jul 07 21:52:21 GMT-03:00 2021 by JosEdu
