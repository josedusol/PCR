--------------------------- MODULE PCRMergeSort3Main ------------------------

(*
   Main module for PCR MergeSort3.
   
   Note: using "I o i o k" indexing scheme.
*)

EXTENDS PCRMergeSort3Types, TLC
...
PCR1 == INSTANCE PCRMergeSort3 WITH 
  InType    <- InType1,
...
\* Last modified Sun Dec 13 19:34:57 UYT 2020 by josedu
