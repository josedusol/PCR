------------------------- MODULE PCRFibPrimes2NMain -----------------------

(*
   Main module for PCR FibPrimes2N.
*)

EXTENDS PCRFibPrimes2NTypes, FiniteSets, TLC
...
PCR1 == INSTANCE PCRFibPrimes2N WITH 
  InType    <- InType1,
...
PCR2 == INSTANCE PCRIsPrimeN WITH
  InType    <- InType2,  
...
PCRFibPrimes1 == INSTANCE PCRFibPrimes1NMain 
  WITH cm1 <- subst

=============================================================================
\* Modification History
\* Last modified Wed Dec 16 14:51:26 UYT 2020 by josedu
