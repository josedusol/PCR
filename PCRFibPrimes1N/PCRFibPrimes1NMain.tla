------------------------- MODULE PCRFibPrimes1NMain ------------------------

(*
   Main module for PCR FibPrimes1N.
   
   This is an experimental alternative version where we use base modules
   that works with arbitrary number of consumers.
*)

EXTENDS PCRFibPrimes1NTypes, FiniteSets, TLC, SequenceTheorems
...
PCR1 == INSTANCE PCRFibPrimes1N WITH 
  InType    <- InType1,
...
\* Last modified Wed Dec 16 14:48:05 UYT 2020 by josedu
